...
/*!********************************!*\
  !*** ./source/js/constants.js ***!
  \********************************/
/*! exports provided: SCREEN_CHANGED_EVENT_TYPE, SCREEN_ACTIVE_SET, THEME_CLASS_NAMES, SCREEN_NAMES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SCREEN_CHANGED_EVENT_TYPE", function() { return SCREEN_CHANGED_EVENT_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SCREEN_ACTIVE_SET", function() { return SCREEN_ACTIVE_SET; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "THEME_CLASS_NAMES", function() { return THEME_CLASS_NAMES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SCREEN_NAMES", function() { return SCREEN_NAMES; });
const SCREEN_CHANGED_EVENT_TYPE = `screenChanged`;
const SCREEN_ACTIVE_SET = `screenActiveSet`;

const THEME_CLASS_NAMES = {
  default: `page--theme-default`,
  purple: `page--theme-purple`,
...
/***/ "./source/js/modules/animation-2d.js":
/*!*******************************************!*\
  !*** ./source/js/modules/animation-2d.js ***!
  \*******************************************/
/*! exports provided: Animation2d */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Animation2d", function() { return Animation2d; });
/* harmony import */ var _utils_easing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/easing */ "./source/js/utils/easing.js");
...
/***/ "./source/js/modules/animation-tick-timer.js":
/*!***************************************************!*\
  !*** ./source/js/modules/animation-tick-timer.js ***!
  \***************************************************/
/*! exports provided: AnimationTickTimer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class FullPageScroll {
  ...
  onUrlHashChanged() {
    ...
    this.previosScreen = this.activeScreen;
  ...
  changePageDisplay() {
    ...
    this.emitChangeDisplayEvent(_constants__WEBPACK_IMPORTED_MODULE_1__["SCREEN_CHANGED_EVENT_TYPE"]);
  ...
  changeVisibilityDisplay() {
    ...
    setTimeout(() => {
      ...
      this.emitChangeDisplayEvent(_constants__WEBPACK_IMPORTED_MODULE_1__["SCREEN_ACTIVE_SET"]);
    }, 350);
  }
...
class GameTimer extends _animation_tick_timer__WEBPACK_IMPORTED_MODULE_0__["AnimationTickTimer"] {
  constructor() {
...
/* harmony import */ var _scene_2d_sea_calf__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scene-2d-sea-calf */ "./source/js/modules/scene-2d-sea-calf.js");
/* harmony import */ var _scene_2d_crocodile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scene-2d-crocodile */ "./source/js/modules/scene-2d-crocodile.js");
...
class Game {
  constructor() {
    this.activeGameScreen = _constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_NAMES"].GAME;
    ...
    this.screenGameEl = document.getElementById(`${_constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_NAMES"].GAME}`);

    this.timer = new _game_timer__WEBPACK_IMPORTED_MODULE_1__["GameTimer"]();
    this.scene2DSeaCalf = new _scene_2d_sea_calf__WEBPACK_IMPORTED_MODULE_2__["Scene2DSeaCalf"]();
    this.scene2DCrocodile = new _scene_2d_crocodile__WEBPACK_IMPORTED_MODULE_3__["Scene2DCrocodile"]();
  ...
  emitChangeDisplayEvent(screenEl) {
    const event = new CustomEvent(_constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_ACTIVE_SET"], {
      detail: {
  ...
  showFailScreen() {
    this.setCurrentResultScreen(_constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_NAMES"].RESULT_NEGATIVE);
    this.scene2DCrocodile.start();
  }
  ...
  checkScreen({detail}) {
    ...
    const isGamePage = screenName === _constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_NAMES"].GAME;
    const isPlayScreen = this.activeGameScreen === _constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_NAMES"].GAME;
  ...
  init() {
    ...
    document.body.addEventListener(_constants__WEBPACK_IMPORTED_MODULE_0__["SCREEN_CHANGED_EVENT_TYPE"], this.checkScreen);
...
/*!*************************************************!*\
  !*** ./source/js/modules/scene-2d-crocodile.js ***!
  \*************************************************/
/*! exports provided: Scene2DCrocodile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Scene2DCrocodile", function() { return Scene2DCrocodile; });
/* harmony import */ var _scene_2d__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scene-2d */ "./source/js/modules/scene-2d.js");
/* harmony import */ var _animation_2d__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animation-2d */ "./source/js/modules/animation-2d.js");
/* harmony import */ var _utils_easing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/easing */ "./source/js/utils/easing.js");
...
class Scene2DCrocodile extends _scene_2d__WEBPACK_IMPORTED_MODULE_0__["Scene2D"] {
  constructor() {
  ...
  initAnimations() {
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_1__["Animation2d"]({
      func: () => {
        this.drawScene();
      },
      duration: `infinite`,
  ...
  initCrocodileAnimations() {
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_1__["Animation2d"]({
      ...
      duration: 600,
      delay: 1350,
      easing: _utils_easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutQuad
    }));
  }
  ...
  initSnowflakeAnimations() {
    ...
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_1__["Animation2d"]({
      ...
      duration: 600,
      delay: 1200,
      easing: _utils_easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeInQuad
    }));
  }
  ...
  initTearDropAnimations() {
    ...
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_1__["Animation2d"]({
      ...
      duration: `infinite`,
      delay: 1900,
      easing: _utils_easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeInOutQuad
    }));
  }
  ...
  initKeyAnimations() {
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_1__["Animation2d"]({
      ...
      duration: 200,
      delay: 500,
      easing: _utils_easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeLinear
    }));
  }
...
/*!************************************************!*\
  !*** ./source/js/modules/scene-2d-sea-calf.js ***!
  \************************************************/
/*! exports provided: Scene2DSeaCalf */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Scene2DSeaCalf", function() { return Scene2DSeaCalf; });
/* harmony import */ var _animation_2d__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation-2d */ "./source/js/modules/animation-2d.js");
...
const IMAGES_URLS = Object.freeze({
  ...
  tree2: `img/module-4/win-primary-images/tree2.png`,
  ice: `img/module-4/win-primary-images/ice.png`,
  seaCalf: `img/module-4/win-primary-images/sea-calf.png`,
...
class Scene2DSeaCalf extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["Scene2D"] {
  constructor() {
  ...
  initAnimations() {
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_0__["Animation2d"]({
      func: () => {
        this.drawScene();
      },
      duration: `infinite`,
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _animation_2d__WEBPACK_IMPORTED_MODULE_0__["Animation2d"]({
      ...
      duration: 2000,
      delay: 600,
      easing: _utils_easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  let storySlider;
  let currentThemeClass = _constants__WEBPACK_IMPORTED_MODULE_2__["THEME_CLASS_NAMES"].purple;
  ...
  const changeTheme = (slideIndex) => {
    if (slideIndex >= 6) {
      changeThemeClass(_constants__WEBPACK_IMPORTED_MODULE_2__["THEME_CLASS_NAMES"].default);
    } else if (slideIndex >= 4) {
      changeThemeClass(_constants__WEBPACK_IMPORTED_MODULE_2__["THEME_CLASS_NAMES"].lightBlue);
    } else if (slideIndex >= 2) {
      changeThemeClass(_constants__WEBPACK_IMPORTED_MODULE_2__["THEME_CLASS_NAMES"].blue);
    } else {
      changeThemeClass(_constants__WEBPACK_IMPORTED_MODULE_2__["THEME_CLASS_NAMES"].purple);
    }
  };
  ...
  document.body.addEventListener(_constants__WEBPACK_IMPORTED_MODULE_2__["SCREEN_ACTIVE_SET"], toggleTheme);
...
/* harmony import */ var _modules_pageLoaded_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/pageLoaded.js */ "./source/js/modules/pageLoaded.js");
...
fullPageScroll.init();
Object(_modules_pageLoaded_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
